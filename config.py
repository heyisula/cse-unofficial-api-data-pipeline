...
# We added a small buffer to catch pre-open and post-close movements
MARKET_OPEN_HOUR = 9
...
# Root directory used for all data storage
DATA_DIR = "data"
# Subdirectory used for symbol reference tables
REFERENCE_DIR = "reference"
# Enable legacy CSV storage alongside timestamped files (Set to True to maintain backward compatibility)
...
# Delay between company info requests (seconds) | This is enforced in fetcher.py to prevent rate limiting
COMPANY_INFO_DELAY_SECONDS = 0.4


# TIMEZONE (Sri Lanka Standard Time offset)
...
# These endpoints are stable, publicly accessible, and don't require session-specific parameters or browser-only authentication
APPROVED_ENDPOINTS = [
...
# These endpoints are protected, unstable, or require hidden parameters generated dynamically by frontend JavaScript. They break automation.
...
# Time to refresh symbol reference table (HH:MM in 24-hour format) |Shortly after market open (09:05) to capture day's symbols
